...
<head>
	...
	<!-- fontawesome -->
	<link rel="stylesheet" href="<?= base_url('assets/template/css/all.min.css') ?>">

	<link rel="stylesheet" href="<?php echo base_url('assets/template/css/bootstrap.min.css'); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url('assets/template/css/fontawesome.min.css'); ?>" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/template/css/jquery-ui.min.css'); ?>" type="text/css">
