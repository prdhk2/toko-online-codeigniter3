        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius: 15px; overflow: hidden;">
                <div class="card-header py-3" style="background: linear-gradient(135deg, #5c90ff 0%, #2a5bd7 100%);">
                    <h5 class="mb-0 text-white"><i class="fas fa-plus-circle me-2"></i> Category Information</h5>
                </div>
                <div class="card-body" style="background-color: #f8faff;">
                    <form action="<?= base_url('category/store') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <button type="reset" class="btn btn-lg me-md-2" style="background-color: #f8f9fa; color:rgb(244, 61, 94) !important; border: 2px solid #5c90ff; border-radius: 10px;">
